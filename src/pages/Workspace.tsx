...
const TITLES: Record<number, { title: string; sub: string }> = {
  ...
  2: { title: 'Создание карточки', sub: 'Соберите сцену и сгенерируйте варианты фона для товара' },
  3: { title: 'Правки и редизайн', sub: 'Тексты, инфографика и коррекция изображения' },
  4: { title: 'Сохранение', sub: 'Экспорт, шаблоны стилей и галерея готовых фотографий' },
}
